...
const state = {
  ...
  customSubtitleNormalColor: '#FFFFFF',
  customSubtitleNormalFontSize: 22,
  customSubtitleNormalBgColor: '#000000',
  customSubtitleNormalBgOpacity: 0.8,
  customSubtitleNormalVPosition: 40,
  customSubtitleNormalTimeOffset: 0,
  customSubtitleNormalContainerWidth: 80,
  customSubtitleFullscreenColor: '#FFFFFF',
  customSubtitleFullscreenFontSize: 28,
  customSubtitleFullscreenBgColor: '#000000',
  customSubtitleFullscreenBgOpacity: 0.7,
  customSubtitleFullscreenVPosition: 60,
  customSubtitleFullscreenTimeOffset: 0,
  customSubtitleFullscreenContainerWidth: 80,
  // KONIEC NOWEGO KODU

  // POCZĄTEK NOWEGO KODU - USTAWIENIA PASKA POSTĘPU
  customProgressBarEnabled: false, // Domyślnie wyłączony, żeby nie psuć UX
  customProgressBarProgressColor: '#F76400',
  customProgressBarProgressOpacity: 1,
  customProgressBarBufferColor: '#808080',
  customProgressBarBufferOpacity: 1,
  customProgressBarUnbufferedColor: '#000000',
  customProgressBarUnbufferedOpacity: 1,
  customProgressBarBarHeight: 3,
  customProgressBarZIndex: 60,
  customProgressBarChaptersEnabled: true,
  customProgressBarChapterMarkerColor: '#FFFFFF',
  // KONIEC NOWEGO KODU
