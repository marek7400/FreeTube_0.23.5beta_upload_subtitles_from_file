...
import CustomProgressBarSettings from '../../components/CustomProgressBarSettings/CustomProgressBarSettings.vue'
// PRZYWRACAM IMPORT
...
export default defineComponent({
  ...
  components: {
    ...
    'custom-progress-bar-settings': CustomProgressBarSettings,
    // PRZYWRACAM REJESTRACJĘ
  ...
  computed: {
    ...
    settingsComponentsData: function () {
      const settingsComponentsData = [
        ...
        {
          type: 'custom-progress-bar-settings',
          title: this.$t('Settings.Player Settings.Custom Progress Bar Settings.Title'),
          icon: 'sliders-h'
        },
        ...(process.env.IS_ELECTRON
          ? [{
